...
class KPAFlowDec(nn.Module):
    def __init__(self, args, chnn=128):
        ...
        self.iter_mask = IterMask(input_dim=chnn+4+7)

    def _mo_enc(self, flow, corr, itr):

        # print('self.C_cor')
        # flops, params = profile(self.C_cor, inputs=(corr,))
        # print('FLOPs = ' + str(flops / 1000 ** 3) + 'G')
        # print('Params = ' + str(params / 1000 ** 2) + 'M')
        # print('*' * 60)
        feat_cor = self.C_cor(corr)
        # print('self.C_flo')
        # flops, params = profile(self.C_flo, inputs=(flow,))
        # print('FLOPs = ' + str(flops / 1000 ** 3) + 'G')
        # print('Params = ' + str(params / 1000 ** 2) + 'M')
        # print('*' * 60)
        # exit(0)
        ...
        # print('self.C_mo')
        # flops, params = profile(self.C_mo, inputs=(feat_cat,))
        # print('FLOPs = ' + str(flops / 1000 ** 3) + 'G')
        # print('Params = ' + str(params / 1000 ** 2) + 'M')
        # print('*' * 60)
    ...
    def forward(self, net, inp, corr, flow, itr, iter_mask=None, tgt_sparsity=None, itr_embedding= None, mhidden=None, upsample=True):

        # exit(0)
        feat_mo = self._mo_enc(flow, corr, itr)
        # print('self.kpa')
        # flops, params = profile(self.kpa, inputs=(inp, feat_mo, itr,))
        # print('FLOPs = ' + str(flops / 1000 ** 3) + 'G')
        # print('Params = ' + str(params / 1000 ** 2) + 'M')
        # print('*' * 60)
        # exit(0)
        ...
        # print('self.C_flow')
        # flops, params = profile(self.C_flow, inputs=(net,))
        # print('FLOPs = ' + str(flops / 1000 ** 3) + 'G')
        # print('Params = ' + str(params / 1000 ** 2) + 'M')
        # print('*' * 60)
        # exit(0)
        ...
        mask_wo_skip = .25 * self.C_mask(net)
        ...
        # print('self.C_mask')
        # flops, params = profile(self.C_mask, inputs=(net,))
        # print('FLOPs = ' + str(flops / 1000 ** 3) + 'G')
        # print('Params = ' + str(params / 1000 ** 2) + 'M')
        # print('*' * 60)
        # exit(0)
    ...
    def forward_time(self, net, inp, corr, flow, itr, iter_mask=None, tgt_sparsity=None, itr_embedding= None, mhidden=None, upsample=True):
