...
CUDA_VISIBLE_DEVICES=0,5 python -u train.py --name raft-sintel --stage sintel --validation sintel --restore_ckpt raft-sintel.pth --gpus 0 1 --num_steps 40000 --batch_size 6 --lr 0.000125 --image_size 368 768 --wdecay 0.00001 --gamma=0.85
CUDA_VISIBLE_DEVICES=0,5 python -u train.py --name raft-kitti  --stage kitti --validation kitti --restore_ckpt raft-kitti.pth --gpus 0 1 --num_steps 20000 --batch_size 6 --lr 0.0001 --image_size 288 960 --wdecay 0.00001 --gamma=0.85
