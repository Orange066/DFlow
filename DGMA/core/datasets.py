...
class FlyingChairs(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/home/user1/optical_flow/FlyingChairs_release_local/data'):
...
class FlyingThings3D(FlowDataset):
    def __init__(self, aug_params=None, root='/mnc/zsl/flyingthings3d_complete', split='training', dstype='frames_cleanpass'):
...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/home/user1/optical_flow/kitti/2015/data_scene_flow'):
...
class HD1K(FlowDataset):
    def __init__(self, aug_params=None, root='/home/user3/datasets/hd1k'):
